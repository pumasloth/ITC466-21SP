...
namespace HW2
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            var grandTotal = CalculateGrandTotal(shippingAmount, taxAmount, total);
            Console.WriteLine("============");
        ...
        public static double CalculateGrandTotal(double shippingAmount, double taxAmount, double total)
        {
            return shippingAmount + taxAmount + total;
        }
